...
public class Lab5_bai2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list.add(new Student("Fpoly Hà Nội", "Quỳnh", "Vĩnh Phúc"));
        list.add(new Student("Fpoly Hà Nội", "Chính", "Nam Định"));
        list.add(new Student("Fpoly Hà Nội", "Quỳnh", "Vĩnh Phúc"));
        list.add(new Student("Fpoly Hà Nội", "Chính", "Nam Định"));
    ...
    public class StudentAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            btnUpdate.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(Lab5_bai2.this, Acticity_suathongtin.class);
                    startActivity(intent);

                    Intent intent1 = getIntent();
                    String name_sua = intent1.getStringExtra   (Acticity_suathongtin.KEY_NAME);
                    String diaChi_sua = intent1.getStringExtra  (Acticity_suathongtin.KEY_DIACHI);
                    String title_sua = intent1.getStringExtra(Acticity_suathongtin.KEY_TITLE);
